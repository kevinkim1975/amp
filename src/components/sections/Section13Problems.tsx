 ...
 * - 매트릭스 배지 겹침 해결: absolute → flexbox 레이아웃
 * - 각 사분면 내 배지를 flex flex-col gap-3으로 수직 정렬
  ...
  return (
    <section className="w-full bg-background">
      <div className="mx-auto max-w-content px-6 min-h-[calc(100vh-144px)] flex flex-col py-4">
        ...
        {/* Priority Matrix - FLEXBOX 기반 (겹침 해결) */}
        <div className="bg-surface border border-border rounded-lg p-4">
          ...
          <div className="relative h-[230px]">
            ...
            {/* Grid Container - 2x2 with FLEXBOX inside each quadrant */}
            <div className="grid grid-cols-2 grid-rows-2 h-full border-2 border-border">
              {/* Top-Left: 어려움/높은영향 - FLEXBOX 수직 정렬 */}
              <div className="border-r border-b border-dashed border-border bg-red-50/30 p-2 flex flex-col">
                <span className="text-[10px] text-text-secondary mb-2">어려움/높은영향</span>
              ...
              {/* Top-Right: 용이/높은영향 - FLEXBOX 수직 정렬, 우측 정렬 */}
              <div className="border-b border-dashed border-border bg-amber-50/20 p-2 flex flex-col">
                <span className="text-[10px] text-text-secondary mb-2 text-right">용이/높은영향</span>
                <div className="flex flex-col gap-3 items-end pr-2 pt-1">
                  <div className="text-right">
                    <span className="inline-block bg-red-500 text-white text-[10px] px-2 py-1 rounded font-medium shadow-sm">
                      2.지역 키워드
                    </span>
                    <span className="block text-[9px] text-text-secondary mt-0.5 mr-1">지식인 확대</span>
                  </div>
                  <div className="text-right">
                    <span className="inline-block bg-amber-500 text-white text-[10px] px-2 py-1 rounded font-medium shadow-sm">
                      3.채널 편중
                    </span>
                    <span className="block text-[9px] text-text-secondary mt-0.5 mr-1">확장 필요</span>
                  </div>
                </div>
              </div>

              {/* Bottom-Left: 어려움/낮은영향 - FLEXBOX 중앙 정렬 */}
              <div className="border-r border-dashed border-border bg-gray-50/30 p-2 flex flex-col justify-between">
                ...
                <span className="text-[10px] text-text-secondary">어려움/낮은영향</span>
              </div>

              {/* Bottom-Right: 용이/낮은영향 - FLEXBOX 중앙 정렬 */}
              <div className="bg-yellow-50/20 p-2 flex flex-col justify-between">
                <div className="flex items-center justify-center flex-1">
                  <div className="pr-2 text-right">
                    <span className="inline-block bg-gray-500 text-white text-[10px] px-2 py-1 rounded font-medium shadow-sm">
                      6.카페 재활성
                    </span>
                    <span className="block text-[9px] text-text-secondary mt-0.5 mr-1">중기 과제</span>
                  </div>
                </div>
                <span className="text-[10px] text-text-secondary text-right">용이/낮은영향</span>
              </div>
            </div>
          </div>
        </div>
