 ...
 *
 * 수정: 2026-01-13 - Flexbox 분배로 하단 여백 최적화
 * - section: flex flex-col 추가
 * - container: flex flex-col flex-1
 * - grid wrapper: flex-1 (여분 공간 흡수)
 * - bottom callout: mt-auto (하단 고정)
 * 
...
export function Section14PhotoStrategy() {
  return (
    <section className="min-h-[calc(100vh-144px)] flex flex-col bg-white">
      <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col flex-1">
        ...
        {/* Insight Callout - mt-auto로 하단 고정 */}
        <div className="mt-auto p-4 bg-[#F6F8FA] border-l-4 border-[#004B8D] rounded-r-lg">
